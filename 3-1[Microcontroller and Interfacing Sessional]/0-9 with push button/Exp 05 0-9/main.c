/*
 * Exp-05 0-9 with CC type 7-Segment.c
 *
 * Created: 6/8/2022 10:00:49 PM
 * Author : G-A2
 
 Goal: This project aims to increment value from 0-9 with the help a push button. The 'DisplayDigit' shows the desired value in the 7 segment CC 
 type  display. POTRC is selected as the output terminal which is connected to the 7-segment display. The 1st pin of PORTD takes input from the push
 button. This code is only to display number from 0-9. If the pushbutton is pressed more after reaching 9, it will not do anything.
