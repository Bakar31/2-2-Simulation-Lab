...
def algorithm ():
      ...
      algorithm.iconbitmap("E:\\PF\\letter_p_jKk_icon.ico")
      label=Label(algorithm, text='Pathfinding Visualizer',relief='solid',font=('arial',12,'bold')).place(x=160,y=0)
      label=Label(algorithm, text="Simple Pathfinding Visualizer was made using Python Tkinter",font=('arial',10,'bold')).place(x=0,y=30)
      label=Label(algorithm, text='Developers:',relief='solid',font=('arial',12,'bold')).place(x=0,y=70)
      label=Label(algorithm, text='Azim Miah - 1808028 - 1808028@student.ruet.ac.bd',font=('arial',10,'bold')).place(x=0,y=100)
      label=Label(algorithm, text='Bishowjit Paul - 1808029 - 1808029@student.ruet.ac.bd ',font=('arial',10,'bold')).place(x=0,y=130)
      label=Label(algorithm, text='A. K. M. Mohibur Rahman - 1808030- 1808030@student.ruet.ac.bd',font=('arial',10,'bold')).place(x=0,y=160)
      label=Label(algorithm, text='Abu Bakar Siddik - 1808031 - 1808031@student.ruet.ac.bd ',font=('arial',10,'bold')).place(x=0,y=190)
      label=Label(algorithm, text='Enamul Hasan Shahed - 1808032 -1808032@student.ruet.ac.bd ',font=('arial',10,'bold')).place(x=0,y=220)
      label=Label(algorithm, text='***feel free to contact with us via the e-mails*** ',font=('arial',10,'bold')).place(x=70,y=270)
...
root.iconbitmap("E:\\PF\\letter_p_jKk_icon.ico")
...
class Example(Frame):
    def __init__(self, master, *pargs):
        ...
        self.image = Image.open("E:\\PF\\background@288x.png")
