...
Photo3 = PhotoImage(file="E:\\PF\\Start@288x1r.png")
btn1 = Button(root, image=Photo3, command=mainevent, border=0, height=20, width=40, bg='red')
btn1.place(x=335, y=150)

Photo1 = PhotoImage(file="E:\\PF\\Exit_1@288x1m.png")
btn2 = Button(root, image=Photo1, command=areusure, border=0, height=20, width=40, bg='red')
btn2.place(x=335, y=185)

Photo2 = PhotoImage(file="E:\\PF\\Info_1@288x1r.png")
btn3 = Button(root, image=Photo2, command=algorithm, border=0, height=20, width=40, bg='red')
btn3.place(x=335, y=215)
